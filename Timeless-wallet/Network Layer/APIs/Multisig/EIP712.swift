...
//  Timeless-wallet
//
//  Created by Vinh Dang on 1/26/22.
//
// Copied & modified from web3swift/Utils/EIP/EIP712.swift as the library doesn't expose it as public field
